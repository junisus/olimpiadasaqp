...
<head>
<meta charset="UTF-8">
<title>Encuentros | Olimpiadas AQP</title>
...
<body>
			...
			<ul class="space-y-2 font-medium">
				<li><a href="eventos"
					class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
						<svg
							class="flex-shrink-0 w-5 h-5 text-gray-500 group-hover:text-gray-900 transition duration-75 dark:text-red-400 group-text-red-900 dark:group-hover:text-white"
  ...
  </svg> <span class="flex-1 ms-3 whitespace-nowrap">Eventos</span>
				</a></li>
				<li><a href="deportes"
					class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
						<svg
  ...
  </svg> <span class="ms-3">Encuentros</span>
				</a></li>
				<li><a href="ranking"
					class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
						<svg
	...
	<div class="p-10 sm:ml-64">
		...
		<div class="text-black-900 text-[25px] font-semibold mt-10">Encuentros</div>
		<div class="flex items-center justify-end mb-4">
			<span data-modal-target="agregar-modal"
    ...
    <path stroke="currentColor" stroke-linecap="round"
	        	...
	        	<div>
	        		...
	        		<div class="flex flex-col justify-between md:flex-row bg-white border-gray-200 rounded-b shadow md:flex-row md:max-w-xl dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
	    				...
	    				<div class="flex flex-col justify-center items-center md:justify-end md:items-end p-4 leading-normal">	        		
	        				<div class="flex">
	        					<span data-modal-target="editar-<%= encuentro.getId() %>" data-modal-toggle="editar-<%= encuentro.getId() %>" class="cursor-pointer p-3 mr-5 text-yellow-900 rounded-lg dark:text-white hover:bg-yellow-100 dark:hover:bg-yellow-700 group">
		...
		<div id="editar-<%= encuentro.getId() %>" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full p-8">
    		<div class="relative p-4 w-full max-w-md max-h-full">
        		...
        		<div class="p-4 md:p-5 relative bg-white rounded-lg shadow dark:bg-gray-700">
            		...
            		<div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                		...
                		<button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                			data-modal-toggle="editar-<%= encuentro.getId() %>">
                    	<svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                        	<path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                    	</svg>
                    	<span class="sr-only">Close modal</span>
            		...
            		<form class="p-4 md:p-5" action="SvUpdateMatch" method="POST">
                		<input name="id-encuentro-edit" type="hidden" id="id-encuentro-edit" value="<%= encuentro.getId() %>">
                			<div class="grid gap-4 mb-4 grid-cols-2">
                    			<div class="col-span-2">
                        		<label for="equipo-a" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        			Equipo A
                        		</label>
                        		<input type="number" name="id-equipo-a-edit" id="id-equipo-a-edit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
                        			placeholder="Escriba el id del equipo A" required="" value="<%= encuentro.getIdEquipoA() %>">
                    		</div>
                    		<div class="col-span-2">
                        		<label for="equipo-b" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        			Equipo B
                        		</label>
                        		<input type="number" name="id-equipo-b-edit" id="id-equipo-b-edit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
                        			placeholder="Escriba el id del equipo B" required="" value="<%= encuentro.getIdEquipoB() %>">
                    		...
                    		<div class="col-span-2 sm:col-span-1">
                        		...
                        		<input name="fecha-edit" type="date" id="fecha-edit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
                        			required="" value="<%= encuentro.getFecha() %>">
                    		</div>
                    		<div class="col-span-2 sm:col-span-1">
                        		<label for="hora" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        			Hora
                        		</label>
		                        <input name="hora-edit" type="time" id="hora-edit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" 
		                        	required="" value="<%= encuentro.getHora() %>">
		                    </div>
		                    <div class="col-span-2">
		                        ...
		                        <input type="text" name="lugar-edit" id="lugar-edit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
		                        	value="<%= encuentro.getLugar() %>" placeholder="Escriba la dirección donde se realizara el encuentro" required="">
		                    </div>
		                    <div class="col-span-2">
		                        <label for="resultado-a" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
		                        	Resultado del equipo A
		                        </label>
		                        <input type="text" name="resultado-a-edit" id="resultado-a-edit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
		                        	placeholder="Escriba el resultado del equipo A" value="<%= encuentro.getResultadoA() %>">
		                    </div>
		                    <div class="col-span-2">
		                        <label for="resultado-b" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
		                        	Resultado del equipo B
		                        </label>
		                        <input type="text" name="resultado-b-edit" id="resultado-b-edit" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
		                        	placeholder="Escriba el resultado del equipo B" value="<%= encuentro.getResultadoB() %>">
		                    </div>
		                </div>
		...
		<div id="agregar-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
    		<div class="relative p-4 w-full max-w-md max-h-full">
        		...
        		<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            		...
            		<form class="p-4 md:p-5" action="SvAddMatch" method="POST">
                		<div class="grid gap-4 mb-4 grid-cols-2">
                    		<div class="col-span-2">
                        		<label for="equipo-a" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        			Equipo A
                        		</label>
                        		<input type="number" name="id-equipo-a" id="id-equipo-a" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
                        			placeholder="Escriba el id del equipo A" required="">
                    		</div>
                    		<div class="col-span-2">
                        		<label for="equipo-b" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        			Equipo B
                        		</label>
                        		<input type="number" name="id-equipo-b" id="id-equipo-b" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
                        			placeholder="Escriba el id del equipo B" required="">
                    		...
                    		<div class="col-span-2 sm:col-span-1">
                        		...
                        		<input name="fecha" type="date" id="fecha" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
                    		</div>
                    		<div class="col-span-2 sm:col-span-1">
                        		<label for="hora" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
                        			Hora
                        		</label>
		                        <input name="hora" type="time" id="hora" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required="">
		                    </div>
		                    <div class="col-span-2">
		                        <label for="lugar" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
		                        	Lugar
		                        ...
		                        <input type="text" name="lugar" id="lugar" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
		                        	placeholder="Escriba la dirección donde se realizara el encuentro" required="">
		                    </div>
		                    <div class="col-span-2">
		                        <label for="resultado-a" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
		                        	Resultado del equipo A
		                        </label>
		                        <input type="text" name="resultado-a" id="resultado-a" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
		                        	placeholder="Escriba el resultado del equipo A">
		                    </div>
		                    <div class="col-span-2">
		                        <label for="resultado-b" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">
		                        	Resultado del equipo B
		                        </label>
		                        <input type="text" name="resultado-b" id="resultado-b" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" 
		                        	placeholder="Escriba el resultado del equipo B">
		                    </div>
		                </div>
		                <button type="submit" class="text-white inline-flex items-center bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">
		                    <svg class="me-1 -ms-1 w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 5a1 1 0 011 1v3h3a1 1 0 110 2h-3v3a1 1 0 11-2 0v-3H6a1 1 0 110-2h3V6a1 1 0 011-1z" clip-rule="evenodd"></path></svg>
