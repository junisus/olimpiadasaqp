...
<body>
	...
	<div class="p-10 sm:ml-64">
		<div class="text-black-900 text-[25px] font-semibold mt-10">Categoria</div>
		...
		<div class="relative overflow-x-auto shadow-md sm:rounded-lg">
			<table
				...
				<thead
					...
					<tr>
						<th scope="col" class="px-6 py-3">Nombre Categoria</th>
				...
				<tbody>
					...
					<tr
						...
						<th scope="row"
							...
							<%=categoria.getNombre()%></th>
						<td class="px-6 py-4"><%=categoria.getDescripcion()%></td>

						<td class="px-6 py-4"><span
							data-modal-target="editar-<%=categoria.getId()%>"
    ...
    <path stroke="currentColor" stroke-linecap="round"
						...
						<td class="px-6 py-4"><span
							data-modal-target="eliminar-<%=categoria.getId()%>"
							data-modal-toggle="eliminar-<%=categoria.getId()%>"
    ...
    <path stroke="currentColor" stroke-linecap="round"
					...
					<!-- Main modal -->
					<div id="editar-<%=categoria.getId()%>" tabindex="-1"
						aria-hidden="true"
						class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full p-8">
						<div class="relative p-4 w-full max-w-md max-h-full">
							<!-- Modal content -->
							<div
								class="p-4 md:p-5 relative bg-white rounded-lg shadow dark:bg-gray-700">
								<!-- Modal header -->
								<div
		...
		<div id="agregar-modal" tabindex="-1" aria-hidden="true"
			...
			<div class="relative p-4 w-full max-w-md max-h-full">
				...
				<div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
					...
					<!-- Modal body -->
					<form class="p-4 md:p-5" action="SvAddCategory" method="POST">
						<div class="grid gap-4 mb-4 grid-cols-2">
							<div class="col-span-2">
								<label for="nombre"
									class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre</label>
