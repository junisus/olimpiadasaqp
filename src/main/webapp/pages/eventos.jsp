    ...
    <path stroke="currentColor" stroke-linecap="round"
        ...
        %>
					<tr
						...
						<td class="px-6 py-4"><span data-modal-target="editar-<%= evento.getId() %>" data-modal-toggle="editar-<%= evento.getId() %>"
    ...
    <div class="relative p-4 w-full max-w-md max-h-full">
        ...
        <div class="p-4 md:p-5 relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white" data-modal-toggle="editar-<%= evento.getId() %>">
                    <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 14">
                        <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6"/>
                    </svg>
                    <span class="sr-only">Close modal</span>
            ...
            <form class="p-4 md:p-5" action="SvUpdateEvent" method="POST">
                ...
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        placeholder="Escriba el nombre del evento" required="" value="<%= evento.getNombre() %>">
                    </div>
                    <div class="col-span-2">
                        ...
                        placeholder="Escriba el nombre del Organizador" required="" value="<%= evento.getOrganizador() %>">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        required="" value="<%= evento.getFechaInicio() %>">
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        required="" value="<%= evento.getFechaFin() %>">
                    </div>
                    <div class="col-span-2">
                        ...
                        placeholder="Escriba la dirección donde se realizara el evento" required="" value="<%= evento.getLugar() %>">
                    </div>
                </div>
