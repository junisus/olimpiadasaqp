...
<head>
<meta charset="UTF-8">
<title>Ranking de jugadores | Olimpiadas AQP </title>
...
<div class="p-10 sm:ml-64">
	<div class="text-black-900 text-[25px] font-semibold mt-10">Ranking de jugadores</div>
	<br></br>
		...
		<table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
			...
			<tbody>
				<tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
					...
					<td class="px-6 py-4">Santiago Munez</td>
				...
				<tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
					...
					<td class="px-6 py-4">Charlie Braithwaite</td>
				...
				<tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
					...
					<td class="px-6 py-4">Leo Mendoza</td>
				...
				<tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
					...
					<td class="px-6 py-4">Juan Román</td>
