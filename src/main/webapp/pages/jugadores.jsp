...
<head>
<meta charset="UTF-8">
<title>Jugadores | Olimpidas AQP</title>
			...
			<li><a href="#" class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
				<svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
    				...
    				<path stroke="currentColor" stroke-linecap="round"
						stroke-linejoin="round" stroke-width="2.2" d="M1 1v14h16M4 10l3-4 4 4 5-5m0 0h-3.207M16 5v3.207" />
  				</svg>
  				<span class="flex-1 ms-3 whitespace-nowrap">
  					Ranking de equipos
  				</span></a>
...
<div class="p-10 sm:ml-64">
	<div class="text-black-900 text-[25px] font-semibold mt-10">Jugadores</div>
						...
						<span data-modal-target="editar-<%= jugador.getId() %>" data-modal-toggle="editar-<%= jugador.getId() %>"
							...
							<svg class="cursor-pointer flex-shrink-0 w-4 h-4 text-yellow-500 transition duration-75 dark:text-yellow-400 group-hover:text-yellow-900 dark:group-hover:text-white"
								aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 21 21">
   								<path stroke="currentColor" stroke-linecap="round"
									stroke-linejoin="round" stroke-width="2" d="M7.418 17.861 1 20l2.139-6.418m4.279 4.279 10.7-10.7a3.027 3.027 0 0 0-2.14-5.165c-.802 0-1.571.319-2.139.886l-10.7 10.7m4.279 4.279-4.279-4.279m2.139 2.14 7.844-7.844m-1.426-2.853 4.279 4.279" />
 								</svg>
						</span>
					</td>
					<td class="px-6 py-4">
						<span data-modal-target="eliminar-<%= jugador.getId() %>" data-modal-toggle="eliminar-<%= jugador.getId() %>"
							class="cursor-pointer flex items-center justify-center p-2 text-red-900 rounded-lg dark:text-white hover:bg-red-100 dark:hover:bg-red-700 group">
								<svg class="flex-shrink-0 w-4 h-4 text-red-500 transition duration-75 dark:text-red-400 group-hover:text-red-900 dark:group-hover:text-white"
									...
									<path stroke="currentColor" stroke-linecap="round"
										stroke-linejoin="round" stroke-width="2" d="M1 5h16M7 8v8m4-8v8M7 1h4a1 1 0 0 1 1 1v3H6V2a1 1 0 0 1 1-1ZM3 5h12v13a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V5Z" />
 								</svg>
						</span>
					</td>
				</tr>
